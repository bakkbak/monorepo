...
function PostCard({ post, deviceId, onClick, onRepost, isReposted }: { post: Post; deviceId: string | null; onClick: () => void; onRepost?: (post: Post) => void; isReposted?: (postId: string) => boolean }) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#1a1a1a] rounded-lg shadow-sm border-2 border-black dark:border-gray-800 mx-3">
        <div className="cursor-pointer" onClick={onClick}>
          <div className="flex items-center gap-3 px-4 pt-4 pb-3">
            ...
            <div className="relative">
              ...
              {showReport && (
                <div className="absolute right-0 top-10 bg-white dark:bg-gray-900 border-2 border-black dark:border-gray-800 rounded-xl shadow-lg z-20 w-56 overflow-hidden">
